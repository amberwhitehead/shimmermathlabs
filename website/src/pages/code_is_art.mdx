...
<img width="400px" src="/poster3.png" alt='Code == Art, Boise Creative Coding Meetup, Wed. Oct 1, 6-7pm Bown Library!, Vector Drawing and the Art of V3GA AKA Julien Gachadoat, Amber Whitehad' />

<video width="400px" src="/poster2.mp4" autoplay loop muted alt='Code == Art, Boise Creative Coding Meetup, Wed. Sep 3, 6-7pm Bown Library!, Shaders and the Art of Inigo Quilez, Jim McKeeth' />

<img width="400px" src="/poster.svg" alt='Code == Art, Boise Creative Coding Meetup, Wed. Aug 6, 6-7pm Bown Library!, Danielle Navarro, Amber Whitehad' />

## What

This is a small Tacoma meetup to talk about art in relation to programming.
Previous meetings were in Boise, ID, current meetings are in Tacoma, WA.
...
* Wed., Aug. 6, 6-7pm, 2025, covered [Danielle Navarro](https://djnavarro.net/), presented by Amber Whitehead.
* Wed., Sep. 3, 6-7pm, 2025, covered [Inigo Quilez](https://iquilezles.org/), presented by Jim McKeeth.
* Wed., Oct. 1, 6-7pm, 2025, covered [Julien Gachadoat](https://www.v3ga.net/), presented by Amber Whitehead. We also
covered Quines and code as art, presented by Katia Hayati.

## Where

_Tacoma Public Library_, _Wheelock Branch_, Meeting room, 3722 North 26th Street, Tacoma, WA 98407.

## Who

I'm Amber Whitehead, the organizer. I'm an independent software developer
...
<figure>
![Me trying to help a student debug their code at a programming summer camp (COSMOS UCSC, 2006).](../assets/cosmos1.jpg)
<figcaption>
...
If you would like to present, email me at amber.whitehead.997@gmail.com.
